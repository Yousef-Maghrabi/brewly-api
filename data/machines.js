const data = {
    "philips": {
        "pmc01": {
            ...
            keySpecs: {
                coffeeTypes: "Espresso, Coffee, Americano, Cappuccino, Latte Macchiato and more (up to 8 varieties).",
                milkSystem: "LatteGo – detachable two-part milk carafe for easy cleaning.",
                coffeeStrengthSettings: "Adjustable aroma/strength settings (5 levels) and coffee length via My Coffee Choice.",
                Grinder: "Integrated ceramic burr grinder with 12 settings.",
                waterTankCapacity: "Approximately 1.8 L (≈ 60 oz) removable water tank.",
                beanContainerCapacity: "Approximately 275 g bean hopper capacity.",
                Dimensions: "Approx. 246 × 372 × 433 mm (W × D × H) / ~9.7″×14.6″×17″.",
                Weight: "Approximately 8 kg / ~18 lb.",
                powerConsumption: "Around 1500 W / 120V (varies by region)."
            },
            features: {
                oneTouchFunctionality: "One-touch button for multiple coffee and milk-based drinks.",
                easyCleaning: "Fully removable brew group, dishwasher-safe LatteGo parts and AquaClean filter support for up to 5,000 cups without descaling.",
                userProfiles: "2 user profiles + Guest profile for personalized settings."
            }
        },
        "pmc02": {
            ...
            price: 300,
            imagePath: "/public/images/pmc02/01.webp",
            keySpecs: {
                coffeeTypes: "Espresso, Coffee, Americano, Cappuccino, Latte Macchiato (up to 5 varieties).",
                milkSystem: "LatteGo – fast frothing cyclonic milk system.",
                coffeeStrengthSettings: "My Coffee Choice system for customizing strength and volume.",
                Grinder: "Ceramic burr grinder with 12 settings.",
                waterTankCapacity: "Approx. 1.8 L (≈ 60 oz).",
                beanContainerCapacity: "About 10 oz (~284 g) hopper capacity in some variants.",
                Dimensions: "Approx. 9.7″ × 14.6″ × 17″ (W × D × H).",
            ...
            features: {
                ...
                easyCleaning: "LatteGo system can be cleaned in 15 seconds, removable brew group and AquaClean filter support.",
        ...
        "pmc03": {
            ...
            price: 250,
            imagePath: "/public/images/pmc03/01.webp",
            keySpecs: {
                ...
                Grinder: "Ceramic burr grinder (12 settings) in many variants of 3200.",
                waterTankCapacity: "Approximately 1.8 L (~60 oz).",
                beanContainerCapacity: "About 10 oz (~284 g) hopper capacity.",
                Dimensions: "Approx. 17″ × 10″ × 15″ (W × D × H).",
                Weight: "Approx. 21 lb (~9.5 kg).",
                powerConsumption: "Around 1350 W / 120 V."
            },
            features: {
        ...
        "pmc04": {
            ...
            price: 200,
            imagePath: "/public/images/pmc04/01.webp",
            keySpecs: {
                coffeeTypes: "Espresso, Coffee, Americano and more.",
                milkSystem: "Classic milk frother (not LatteGo).",
    ...
    "saoco": {
        "smc01": {
            ...
            price: 400.99,
            imagePath: "/public/images/smc01/01.webp",
            keySpecs: {
        ...
        "smc02": {
            ...
            price: 399.99,
            imagePath: "/public/images/smc02/01.webp",
            keySpecs: {
